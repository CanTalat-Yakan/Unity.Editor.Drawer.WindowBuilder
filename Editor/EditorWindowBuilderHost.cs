...
namespace UnityEssentials
{
    ...
    public partial class EditorWindowBuilder : EditorWindow
    {
        ...
        public static EditorWindowBuilder CreateInstance() =>
            CreateInstance<EditorWindowBuilder>()
                .Initialize();
        ...
        public static EditorWindowBuilder CreateInstance(
            ...
            bool centerY = false)
        {
            return CreateInstance<EditorWindowBuilder>()
                .Initialize(title, minSize, size, position, centerX, centerY);
        }

        private EditorWindowBuilder Initialize()
        {
            var size = s_minSize;
